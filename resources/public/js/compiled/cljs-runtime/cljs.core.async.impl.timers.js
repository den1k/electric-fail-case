...
var i_31710 = (self__.level + (1));
while(true){
if((i_31710 <= (new_level + (1)))){
(update[i_31710] = self__.header);

var G__31711 = (i_31710 + (1));
i_31710 = G__31711;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_31713 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31713[i]));
} else {
x__$2.forward.push((((i < links_31713.length))?(links_31713[i]):null));
}

if((i < links_31713.length)){
(links_31713[i] = x__$2);
} else {
links_31713.push(x__$2);
}
...
var i_31719 = (0);
while(true){
if((i_31719 <= self__.level)){
var links_31720 = (update[i_31719]).forward;
if((x__$1 === (((i_31719 < links_31720.length))?(links_31720[i_31719]):null))){
(links_31720[i_31719] = (x__$1.forward[i_31719]));

var G__31721 = (i_31719 + (1));
i_31719 = G__31721;
continue;
} else {
var G__31722 = (i_31719 + (1));
i_31719 = G__31722;
continue;
}
} else {
