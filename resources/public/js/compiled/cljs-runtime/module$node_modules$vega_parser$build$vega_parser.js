...
1,extra=!0,offset$jscomp$0=0):(band$jscomp$0=.5,extra=!1):(band$jscomp$0=_$jscomp$0("bandPosition"),extra=_$jscomp$0("tickExtra"));var JSCompiler_object_inline_extra_2897=extra;var JSCompiler_object_inline_band_2898=band$jscomp$0;var JSCompiler_object_inline_offset_2899=offset$jscomp$0;const datum={scale:_$jscomp$1.scale,ticks:!!_$jscomp$0("ticks"),labels:!!_$jscomp$0("labels"),grid:!!_$jscomp$0("grid"),domain:!!_$jscomp$0("domain"),title:null!=_$jscomp$1.title},dataRef=ref$jscomp$0(scope.add(Collect({},
[datum]))),ticksRef=ref$jscomp$0(scope.add(AxisTicks({scale:scope.scaleRef(_$jscomp$1.scale),extra:scope.property(JSCompiler_object_inline_extra_2897),count:scope.objectProperty(_$jscomp$1.tickCount),values:scope.objectProperty(_$jscomp$1.values),minstep:scope.property(_$jscomp$1.tickMinStep),formatType:scope.property(_$jscomp$1.formatType),formatSpecifier:scope.property(_$jscomp$1.format)}))),children=[];let size;if(datum.grid){var JSCompiler_temp_const$jscomp$1=children.push,userEncode=encode$jscomp$0.grid;
...
{stroke:_("gridColor"),strokeCap:_("gridCap"),strokeDash:_("gridDash"),strokeDashOffset:_("gridDashOffset"),strokeOpacity:_("gridOpacity"),strokeWidth:_("gridWidth")});const tickPos={scale:_$jscomp$1.scale,field:"value",band:JSCompiler_object_inline_band_2898,extra:JSCompiler_object_inline_extra_2897,offset:JSCompiler_object_inline_offset_2899,round:_("tickRound")},sz=ifX(orient,{signal:"height"},{signal:"width"}),gridStart=vscale?{scale:vscale,range:0,mult:sign,offset}:{value:0,offset},gridEnd=vscale?
