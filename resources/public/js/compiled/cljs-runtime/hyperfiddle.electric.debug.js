...
var _STAR_print_level_STAR__orig_val__29554 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_length_STAR__orig_val__29555 = cljs.core._STAR_print_length_STAR_;
var _STAR_print_level_STAR__temp_val__29557 = (1);
var _STAR_print_length_STAR__temp_val__29558 = (4);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29557);

(cljs.core._STAR_print_length_STAR_ = _STAR_print_length_STAR__temp_val__29558);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([arg], 0));
}finally {(cljs.core._STAR_print_length_STAR_ = _STAR_print_length_STAR__orig_val__29555);

(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29554);
}
}
}
}
...
var G__29615 = new cljs.core.Keyword("hyperfiddle.electric.debug","trace","hyperfiddle.electric.debug/trace",1332052033).cljs$core$IFn$_invoke$arity$1(cljs.core.ex_data(err));
var G__29615__$1 = (((G__29615 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (frame){
...
var G__29615__$2 = (((G__29615__$1 == null))?null:cljs.core.filter.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("hyperfiddle.electric.debug","type","hyperfiddle.electric.debug/type",-166806812),G__29615__$1));
var G__29615__$3 = (((G__29615__$2 == null))?null:cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,frame){
if(typeof frame === 'string'){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(r,frame);
} else {
var map__29636 = hyperfiddle.electric.debug.normalize_frame(frame);
var map__29636__$1 = cljs.core.__destructure_map(map__29636);
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","origin","hyperfiddle.electric.debug/origin",-1379474448));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","type","hyperfiddle.electric.debug/type",-166806812));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","name","hyperfiddle.electric.debug/name",-35961215));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","params","hyperfiddle.electric.debug/params",-1701534765));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","args","hyperfiddle.electric.debug/args",-1101355176));
var macro = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","macro","hyperfiddle.electric.debug/macro",-46765604));
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","scope","hyperfiddle.electric.debug/scope",-708382234));
var meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29636__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","meta","hyperfiddle.electric.debug/meta",-368038788));
...
var and__5043__auto____$1 = cljs.core.not((function (){var fexpr__29651 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"transfer","transfer",327423400),null,new cljs.core.Keyword(null,"toggle","toggle",1291842030),null], null), null);
return (fexpr__29651.cljs$core$IFn$_invoke$arity$1 ? fexpr__29651.cljs$core$IFn$_invoke$arity$1(type) : fexpr__29651.call(null,type));
})());
...
})())?null:null),(function (){var G__29653 = scope;
...
})()], null),cljs.core.into.cljs$core$IFn$_invoke$arity$2((function (){var G__29655 = type;
var G__29655__$1 = (((G__29655 instanceof cljs.core.Keyword))?G__29655.fqn:null);
switch (G__29655__$1) {
case "apply":
return cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,"(",null,(1),null)),(new cljs.core.List(null,(function (){var G__29659 = name;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol("hyperfiddle.electric.impl.runtime","fail","hyperfiddle.electric.impl.runtime/fail",-1672627762,null),G__29659)){
...
break;
case "eval":
var map__29661 = frame;
var map__29661__$1 = cljs.core.__destructure_map(map__29661);
var action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29661__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","action","hyperfiddle.electric.debug/action",1557442480));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29661__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","target","hyperfiddle.electric.debug/target",2130291153));
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29661__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","method","hyperfiddle.electric.debug/method",-1822364192));
var args__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29661__$1,new cljs.core.Keyword("hyperfiddle.electric.debug","args","hyperfiddle.electric.debug/args",-1101355176));
var G__29662 = action;
...
})(),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(macro)?["from macro ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(macro)].join(''):null),(function (){var G__29724 = new cljs.core.Keyword(null,"file","file",-1269645878).cljs$core$IFn$_invoke$arity$1(meta);
if((G__29724 == null)){
return null;
} else {
return ["in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29724)].join('');
}
})(),(function (){var G__29725 = new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(meta);
if((G__29725 == null)){
return null;
} else {
return ["line ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29725)].join('');
}
})()], null))));
}
}),cljs.core.PersistentVector.EMPTY,G__29615__$2));
var G__29615__$4 = (((G__29615__$3 == null))?null:cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (frame){
if(typeof frame === 'string'){
return frame;
} else {
