...
var ensure_set_60801 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(m)),(ensure_set_60801.cljs$core$IFn$_invoke$arity$1 ? ensure_set_60801.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_60801.call(null,ks)));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_60801.cljs$core$IFn$_invoke$arity$1 ? ensure_set_60801.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_60801.call(null,ks)));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_60801.cljs$core$IFn$_invoke$arity$1 ? ensure_set_60801.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_60801.call(null,ks)));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_((function (p1__60449_SHARP_){
return taoensso.truss.impl.some_QMARK_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__60449_SHARP_));
}),ks);
});
...
}catch (e60468){if((e60468 instanceof Error)){
var _ = e60468;
return null;
} else {
throw e60468;
...
var vec__60526 = pred;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60526,(0),null);
var a1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60526,(1),null);
var a2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60526,(2),null);
var a3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60526,(3),null);
...
var G__60535 = type;
var G__60535__$1 = (((G__60535 instanceof cljs.core.Keyword))?G__60535.fqn:null);
switch (G__60535__$1) {
case "set=":
...
var vec__60611 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [self(a1),self(a2),self(a3)], null);
var vec__60614 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60611,(0),null);
var a1__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60614,(0),null);
var sf_a1_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60614,(1),null);
var vec__60617 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60611,(1),null);
var a2__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60617,(0),null);
var sf_a2_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60617,(1),null);
var vec__60620 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60611,(2),null);
var a3__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60620,(0),null);
var sf_a3_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60620,(1),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60627__$1)].join('')));
...
var G__60719 = (new cljs.core.Delay((function (){
...
}catch (e60738){if((e60738 instanceof Error)){
var e = e60738;
...
return (error_fn.cljs$core$IFn$_invoke$arity$1 ? error_fn.cljs$core$IFn$_invoke$arity$1(G__60719) : error_fn.call(null,G__60719));
} else {
return null;
}
});
