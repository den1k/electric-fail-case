...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__11803__auto__){
var self__ = this;
var self__ = this;
var G__39088 = (arguments.length - (1));
switch (G__39088) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args39086){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args39086)));
}));
...
var vec__39108 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39108,(0),null);
...
var G__39132 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__39132) : f_BANG_.call(null,G__39132));
} else {
return null;
}
});
