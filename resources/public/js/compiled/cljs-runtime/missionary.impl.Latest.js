...
(missionary.impl.Latest.Process.prototype.call = (function (unused__11803__auto__){
var self__ = this;
var self__ = this;
...
(missionary.impl.Latest.Process.prototype.apply = (function (self__,args38655){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args38655)));
}));
...
var fexpr__38680_38738 = (inputs[i]);
(fexpr__38680_38738.cljs$core$IFn$_invoke$arity$0 ? fexpr__38680_38738.cljs$core$IFn$_invoke$arity$0() : fexpr__38680_38738.call(null));
...
if((ps.alive === (0))){
var fexpr__38705_38753 = ps.terminator;
(fexpr__38705_38753.cljs$core$IFn$_invoke$arity$0 ? fexpr__38705_38753.cljs$core$IFn$_invoke$arity$0() : fexpr__38705_38753.call(null));
} else {
}
...
var fexpr__38714 = ps.terminator;
return (fexpr__38714.cljs$core$IFn$_invoke$arity$0 ? fexpr__38714.cljs$core$IFn$_invoke$arity$0() : fexpr__38714.call(null));
}
} else {
return null;
}
...
var n__5636__auto___38755 = arity;
var index_38757 = (0);
while(true){
if((index_38757 < n__5636__auto___38755)){
(inputs[index_38757] = (function (){var G__38717 = ((function (index_38757,n__5636__auto___38755,it,arity,args,inputs,dirty,ps,done){
return (function (){
missionary.impl.Heap.enqueue(dirty,index_38757);
...
while(true){
try{cljs.core.deref((inputs[missionary.impl.Heap.dequeue(dirty)]));
}catch (e38721){var __38760 = e38721;
}
if((missionary.impl.Heap.size(dirty) > (0))){
continue;
} else {
...
});})(index_38757,n__5636__auto___38755,it,arity,args,inputs,dirty,ps,done))
;
var G__38718 = done;
var fexpr__38716 = it.next();
return (fexpr__38716.cljs$core$IFn$_invoke$arity$2 ? fexpr__38716.cljs$core$IFn$_invoke$arity$2(G__38717,G__38718) : fexpr__38716.call(null,G__38717,G__38718));
})());

var G__38761 = (index_38757 + (1));
index_38757 = G__38761;
continue;
} else {
}
break;
