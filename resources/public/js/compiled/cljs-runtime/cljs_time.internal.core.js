...
var len__5769__auto___67606 = arguments.length;
var i__5770__auto___67607 = (0);
while(true){
if((i__5770__auto___67607 < len__5769__auto___67606)){
args__5775__auto__.push((arguments[i__5770__auto___67607]));

var G__67608 = (i__5770__auto___67607 + (1));
i__5770__auto___67607 = G__67608;
continue;
} else {
}
break;
...
if(cljs.core.every_QMARK_((function (p1__67592_SHARP_){
return (p1__67592_SHARP_ instanceof goog.date.Date);
}),args)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67593_SHARP_){
return p1__67593_SHARP_.getTime();
}),args));
} else {
...
/** @this {Function} */
(cljs_time.internal.core._EQ_.cljs$lang$applyTo = (function (seq67594){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq67594));
}));
...
var G__67595 = (cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([month,(1)], 0)))?(11):(month - (1)));
return (cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1 ? cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1(G__67595) : cljs_time.internal.core.days_in_month.call(null,G__67595));
});
cljs_time.internal.core.year_corrected_dim = (function cljs_time$internal$core$year_corrected_dim(year,month){
var G__67596 = cljs_time.internal.core.corrected_dim(month);
...
cljs_time.internal.core.valid_date_QMARK_ = (function cljs_time$internal$core$valid_date_QMARK_(p__67597){
var map__67598 = p__67597;
var map__67598__$1 = cljs.core.__destructure_map(map__67598);
var d = map__67598__$1;
var minutes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"minutes","minutes",1319166394));
var millis = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"millis","millis",-1338288387));
var day_of_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"day-of-week","day-of-week",1639326729));
var months = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"months","months",-45571637));
var days = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"days","days",-1394072564));
var weekyear = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"weekyear","weekyear",-74064500));
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194));
var weekyear_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"weekyear-week","weekyear-week",795291571));
var hours = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"hours","hours",58380855));
var years = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67598__$1,new cljs.core.Keyword(null,"years","years",-1298579689));
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Date is not valid",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"invalid-date","invalid-date",2030506573),new cljs.core.Keyword(null,"date","date",-1463434462),d,new cljs.core.Keyword(null,"errors","errors",-908790718),(function (){var G__67599 = cljs.core.PersistentArrayMap.EMPTY;
var G__67599__$1 = ((months_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599,new cljs.core.Keyword(null,"months","months",-45571637),months):G__67599);
var G__67599__$2 = ((days_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599__$1,new cljs.core.Keyword(null,"days","days",-1394072564),days):G__67599__$1);
var G__67599__$3 = ((hours_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599__$2,new cljs.core.Keyword(null,"hours","hours",58380855),hours):G__67599__$2);
var G__67599__$4 = ((minutes_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599__$3,new cljs.core.Keyword(null,"minutes","minutes",1319166394),minutes):G__67599__$3);
var G__67599__$5 = ((seconds_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599__$4,new cljs.core.Keyword(null,"seconds","seconds",-445266194),seconds):G__67599__$4);
var G__67599__$6 = ((millis_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599__$5,new cljs.core.Keyword(null,"millis","millis",-1338288387),millis):G__67599__$5);
var G__67599__$7 = ((weekyear_week_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599__$6,new cljs.core.Keyword(null,"weekyear-week","weekyear-week",795291571),weekyear_week):G__67599__$6);
if(day_of_week_QMARK_ === false){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67599__$7,new cljs.core.Keyword(null,"day-of-week","day-of-week",1639326729),day_of_week);
} else {
return G__67599__$7;
}
})()], null));
...
return cljs.core.first(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__67601_SHARP_,p2__67600_SHARP_){
if(cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p2__67600_SHARP_,x], 0)))){
return p1__67601_SHARP_;
} else {
return null;
}
}),coll));
...
/** @this {Function} */
(cljs_time.internal.core.format.cljs$lang$applyTo = (function (seq67602){
var G__67603 = cljs.core.first(seq67602);
var seq67602__$1 = cljs.core.next(seq67602);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67603,seq67602__$1);
}));
