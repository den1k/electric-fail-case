...
var periods__$1 = cljs.core.vec((function (){var G__67854 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67853_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__67853_SHARP_,(0),(3));
}),G__67854);
} else {
return G__67854;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__67861){
var vec__67862 = p__67861;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67862,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67862,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__67865 = pattern;
switch (G__67865) {
case "S":
...
var G__67874 = key;
var G__67874__$1 = (((G__67874 instanceof cljs.core.Keyword))?G__67874.fqn:null);
switch (G__67874__$1) {
case "millis":
return (function (p1__67866_SHARP_){
return p1__67866_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__67867_SHARP_){
return p1__67867_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__67868_SHARP_){
return p1__67868_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__67869_SHARP_){
return p1__67869_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__67870_SHARP_){
return p1__67870_SHARP_.getHours();
});

break;
case "day":
return (function (p1__67871_SHARP_){
return p1__67871_SHARP_.getDate();
});

break;
case "month":
return (function (p1__67872_SHARP_){
return p1__67872_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__67873_SHARP_){
return p1__67873_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__67874__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__67875){
var vec__67876 = p__67875;
var seq__67877 = cljs.core.seq(vec__67876);
var first__67878 = cljs.core.first(seq__67877);
var seq__67877__$1 = cljs.core.next(seq__67877);
var key = first__67878;
var args = seq__67877__$1;
var G__67879 = key;
var G__67879__$1 = (((G__67879 instanceof cljs.core.Keyword))?G__67879.fqn:null);
switch (G__67879__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__67880 = (function (){var G__67883 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__67883) : syntax_list.call(null,G__67883));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__67879__$1)].join('')));
...
var d = value;
var G__67887 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__67888 = G__67887;
...
var unparser = first__67890;
var more = seq__67889__$1;
var s = "";
var d__$1 = d;
var G__67887__$1 = G__67887;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__67897 = G__67887__$1;
var seq__67898 = cljs.core.seq(vec__67897);
var first__67899 = cljs.core.first(seq__67898);
var seq__67898__$1 = cljs.core.next(seq__67898);
var unparser__$1 = first__67899;
var more__$1 = seq__67898__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__67900 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67900,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67900,(1),null);
var G__67927 = d__$3;
var G__67928 = more__$1;
var G__67929 = s__$3;
d__$1 = G__67927;
G__67887__$1 = G__67928;
s__$1 = G__67929;
continue;
}
break;
