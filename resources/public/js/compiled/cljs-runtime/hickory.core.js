...
var hickory$core$HiccupRepresentable$as_hiccup$dyn_60754 = (function (this$){
...
return hickory$core$HiccupRepresentable$as_hiccup$dyn_60754(this$);
}
});
...
var hickory$core$HickoryRepresentable$as_hickory$dyn_60764 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hickory$core$HickoryRepresentable$as_hickory$dyn_60764(this$);
}
});
...
var pred__60682 = cljs.core._EQ_;
var expr__60683 = (this$["nodeType"]);
if(cljs.core.truth_((pred__60682.cljs$core$IFn$_invoke$arity$2 ? pred__60682.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__60683) : pred__60682.call(null,hickory.core.Attribute,expr__60683)))){
...
if(cljs.core.truth_((pred__60682.cljs$core$IFn$_invoke$arity$2 ? pred__60682.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__60683) : pred__60682.call(null,hickory.core.Comment,expr__60683)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__60682.cljs$core$IFn$_invoke$arity$2 ? pred__60682.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__60683) : pred__60682.call(null,hickory.core.Document,expr__60683)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"]));
} else {
if(cljs.core.truth_((pred__60682.cljs$core$IFn$_invoke$arity$2 ? pred__60682.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__60683) : pred__60682.call(null,hickory.core.DocumentType,expr__60683)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__60682.cljs$core$IFn$_invoke$arity$2 ? pred__60682.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__60683) : pred__60682.call(null,hickory.core.Element,expr__60683)))){
var tag = hickory.utils.lower_case_keyword((this$["tagName"]));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["attributes"])))], null),(cljs.core.truth_((hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(tag) : hickory.utils.unescapable_content.call(null,tag)))?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60678_SHARP_){
return (p1__60678_SHARP_["wholeText"]);
}),(this$["childNodes"])):cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"])))));
} else {
if(cljs.core.truth_((pred__60682.cljs$core$IFn$_invoke$arity$2 ? pred__60682.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__60683) : pred__60682.call(null,hickory.core.Text,expr__60683)))){
return hickory.utils.html_escape((this$["wholeText"]));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__60683)].join('')));
}
}
}
}
...
var pred__60709 = cljs.core._EQ_;
var expr__60710 = (this$["nodeType"]);
if(cljs.core.truth_((pred__60709.cljs$core$IFn$_invoke$arity$2 ? pred__60709.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__60710) : pred__60709.call(null,hickory.core.Attribute,expr__60710)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__60709.cljs$core$IFn$_invoke$arity$2 ? pred__60709.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__60710) : pred__60709.call(null,hickory.core.Comment,expr__60710)))){
...
if(cljs.core.truth_((pred__60709.cljs$core$IFn$_invoke$arity$2 ? pred__60709.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__60710) : pred__60709.call(null,hickory.core.Document,expr__60710)))){
...
if(cljs.core.truth_((pred__60709.cljs$core$IFn$_invoke$arity$2 ? pred__60709.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__60710) : pred__60709.call(null,hickory.core.DocumentType,expr__60710)))){
...
if(cljs.core.truth_((pred__60709.cljs$core$IFn$_invoke$arity$2 ? pred__60709.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__60710) : pred__60709.call(null,hickory.core.Element,expr__60710)))){
...
if(cljs.core.truth_((pred__60709.cljs$core$IFn$_invoke$arity$2 ? pred__60709.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__60710) : pred__60709.call(null,hickory.core.Text,expr__60710)))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__60710)].join('')));
}
}
}
}
...
var temp__5804__auto___60794 = cljs.core.first((doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5804__auto___60794)){
var title_el_60795 = temp__5804__auto___60794;
if(cljs.core.empty_QMARK_((title_el_60795["text"]))){
hickory.core.remove_el(title_el_60795);
} else {
}
} else {
}
