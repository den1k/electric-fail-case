...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_39563 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_39563(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_39567 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_39567(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_39569 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_39569(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_39570 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_39570(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_39574 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_39574(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___39585 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___39585)){
var observer_39586 = temp__5802__auto___39585;
(observer_39586.cljs$core$IFn$_invoke$arity$1 ? observer_39586.cljs$core$IFn$_invoke$arity$1(val) : observer_39586.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__39545 = q;
var G__39546 = start;
var G__39547 = timeout;
var G__39548 = missing_value;
var G__39549 = (n - (1));
var G__39550 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__39545,G__39546,G__39547,G__39548,G__39549,G__39550) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__39545,G__39546,G__39547,G__39548,G__39549,G__39550));
}
}));
});
