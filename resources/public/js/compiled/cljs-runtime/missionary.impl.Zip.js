...
(missionary.impl.Zip.Process.prototype.call = (function (unused__11803__auto__){
var self__ = this;
var self__ = this;
var G__39348 = (arguments.length - (1));
switch (G__39348) {
case (0):
...
(missionary.impl.Zip.Process.prototype.apply = (function (self__,args39347){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args39347)));
}));
...
var temp__5808__auto___39425 = (its[i]);
if((temp__5808__auto___39425 == null)){
} else {
var it_39426 = temp__5808__auto___39425;
(it_39426.cljs$core$IFn$_invoke$arity$0 ? it_39426.cljs$core$IFn$_invoke$arity$0() : it_39426.call(null));
}
...
var n__5636__auto___39435 = its.length;
var i_39436 = (0);
while(true){
if((i_39436 < n__5636__auto___39435)){
(z.pending = (z.pending + (1)));

(res[i_39436] = cljs.core.deref((its[i_39436])));

var G__39438 = (i_39436 + (1));
i_39436 = G__39438;
continue;
} else {
}
...
if((z.pending === (0))){
var fexpr__39370_39440 = z.notifier;
(fexpr__39370_39440.cljs$core$IFn$_invoke$arity$0 ? fexpr__39370_39440.cljs$core$IFn$_invoke$arity$0() : fexpr__39370_39440.call(null));
} else {
}
...
while(true){
if((i__$1 < cnt)){
var G__39443 = (i__$1 + (1));
var G__39444 = (function (){var temp__5806__auto__ = (its[i__$1]);
if((temp__5806__auto__ == null)){
return f__$1;
} else {
var it = temp__5806__auto__;
try{cljs.core.deref(it);
}catch (e39396){var __39446 = e39396;
}
return (f__$1 + (1));
}
})();
...
var index_39448 = (0);
while(true){
(z.iterators[index_39448] = (function (){var G__39400 = ((function (index_39448,c,i,z){
return (function (){
var p = (z.pending - (1));
(z.pending = p);

if((p === (0))){
var fexpr__39403 = z.notifier;
return (fexpr__39403.cljs$core$IFn$_invoke$arity$0 ? fexpr__39403.cljs$core$IFn$_invoke$arity$0() : fexpr__39403.call(null));
} else {
return null;
}
});})(index_39448,c,i,z))
;
var G__39401 = ((function (index_39448,G__39400,c,i,z){
return (function (){
(z.iterators[index_39448] = null);
...
if((p === (0))){
var fexpr__39410 = z.notifier;
return (fexpr__39410.cljs$core$IFn$_invoke$arity$0 ? fexpr__39410.cljs$core$IFn$_invoke$arity$0() : fexpr__39410.call(null));
} else {
return null;
}
}
});})(index_39448,G__39400,c,i,z))
;
var fexpr__39399 = i.next();
return (fexpr__39399.cljs$core$IFn$_invoke$arity$2 ? fexpr__39399.cljs$core$IFn$_invoke$arity$2(G__39400,G__39401) : fexpr__39399.call(null,G__39400,G__39401));
})());

if(cljs.core.truth_(i.hasNext())){
var G__39490 = (index_39448 + (1));
index_39448 = G__39490;
continue;
} else {
}
break;
...
var fexpr__39413_39491 = z.notifier;
(fexpr__39413_39491.cljs$core$IFn$_invoke$arity$0 ? fexpr__39413_39491.cljs$core$IFn$_invoke$arity$0() : fexpr__39413_39491.call(null));
} else {
}
