...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__11803__auto__){
var self__ = this;
var self__ = this;
var G__39198 = (arguments.length - (1));
switch (G__39198) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args39196){
var self__ = this;
var self____$1 = this;
...
var G__39238 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__39237 = s.failure;
return (fexpr__39237.cljs$core$IFn$_invoke$arity$1 ? fexpr__39237.cljs$core$IFn$_invoke$arity$1(G__39238) : fexpr__39237.call(null,G__39238));
} else {
return null;
}
});
