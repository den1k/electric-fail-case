...
while(true){
if((i__5770__auto___32647 < len__5769__auto___32645)){
...
var _STAR_print_newline_STAR__orig_val__32316_32649 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__32317_32650 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__32318_32651 = true;
var _STAR_print_fn_STAR__temp_val__32319_32652 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__32318_32651);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__32319_32652);

try{var _STAR_print_level_STAR__orig_val__32320_32655 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32321_32656 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32321_32656);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32320_32655);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__32317_32650);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__32316_32649);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq32299){
...
var new_formatters = current_formatters.filter((function (p1__32449_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__32449_SHARP_)));
}));
...
var G__32466_32720 = f;
var target__27644__auto___32721 = G__32466_32720;
if(cljs.core.truth_(target__27644__auto___32721)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32466_32720)].join(''),"\n","target__27644__auto__"].join('')));
}

(target__27644__auto___32721["toString"] = (function (){
...
var G__32475_32725 = "%c%s";
var G__32476_32726 = "color:transparent";
var G__32477_32727 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__32475_32725,G__32476_32726,G__32477_32727) : f.call(null,G__32475_32725,G__32476_32726,G__32477_32727));
...
var vec__32517 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32517,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32517,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__32737__delegate = function (add_fmt,add_args){
...
var G__32737 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__32739__i = 0, G__32739__a = new Array(arguments.length -  1);
while (G__32739__i < G__32739__a.length) {G__32739__a[G__32739__i] = arguments[G__32739__i + 1]; ++G__32739__i;}
  add_args = new cljs.core.IndexedSeq(G__32739__a,0,null);
} 
return G__32737__delegate.call(this,add_fmt,add_args);};
G__32737.cljs$lang$maxFixedArity = 1;
G__32737.cljs$lang$applyTo = (function (arglist__32740){
var add_fmt = cljs.core.first(arglist__32740);
var add_args = cljs.core.rest(arglist__32740);
return G__32737__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq32503){
...
var G__32506 = cljs.core.first(seq32503__$2);
var seq32503__$3 = cljs.core.next(seq32503__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32504,G__32505,G__32506,seq32503__$3);
}));
...
var seq__32536 = cljs.core.seq(features);
var chunk__32537 = null;
var count__32538 = (0);
var i__32539 = (0);
while(true){
if((i__32539 < count__32538)){
var feature = chunk__32537.cljs$core$IIndexed$_nth$arity$2(null,i__32539);
...
var G__32747 = seq__32536;
var G__32748 = chunk__32537;
var G__32749 = count__32538;
var G__32750 = (i__32539 + (1));
seq__32536 = G__32747;
chunk__32537 = G__32748;
count__32538 = G__32749;
i__32539 = G__32750;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__32536);
if(temp__5804__auto__){
var seq__32536__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__32536__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__32536__$1);
var G__32756 = cljs.core.chunk_rest(seq__32536__$1);
var G__32757 = c__5568__auto__;
var G__32758 = cljs.core.count(c__5568__auto__);
var G__32759 = (0);
seq__32536 = G__32756;
chunk__32537 = G__32757;
count__32538 = G__32758;
i__32539 = G__32759;
continue;
} else {
var feature = cljs.core.first(seq__32536__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__32763 = cljs.core.next(seq__32536__$1);
var G__32764 = null;
var G__32765 = (0);
var G__32766 = (0);
seq__32536 = G__32763;
chunk__32537 = G__32764;
count__32538 = G__32765;
i__32539 = G__32766;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o32610 = temp__5802__auto__;
return (o32610["version"]);
} else {
return null;
}
})() == null);
