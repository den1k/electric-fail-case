...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__11803__auto__){
var self__ = this;
var self__ = this;
var G__38993 = (arguments.length - (1));
switch (G__38993) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args38992){
var self__ = this;
var self____$1 = this;
...
var G__39013 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__39013) : f_BANG_.call(null,G__39013));
} else {
return null;
}
});
} else {
var vec__39014 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39014,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__38987_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__38987_SHARP_) : s_BANG_.call(null,p1__38987_SHARP_));
});
...
var G__39022 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__39022) : f_BANG_.call(null,G__39022));
} else {
return null;
}
});
} else {
var vec__39023 = temp__5806__auto__;
var vec__39026 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39023,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39026,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39026,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
