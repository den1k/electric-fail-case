...
(missionary.impl.Dataflow.Port.prototype.call = (function (unused__11803__auto__){
var self__ = this;
var self__ = this;
var G__39041 = (arguments.length - (1));
switch (G__39041) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args39039){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args39039)));
}));
...
var _BANG_ = (function (p1__39035_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__39035_SHARP_) : s_BANG_.call(null,p1__39035_SHARP_));
});
...
var G__39092 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__39092) : f_BANG_.call(null,G__39092));
} else {
return null;
}
}
