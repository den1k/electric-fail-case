...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__11803__auto__){
var self__ = this;
var self__ = this;
var G__39062 = (arguments.length - (1));
switch (G__39062) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args39061){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args39061)));
}));
...
var vec__39073 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39073,(0),null);
...
var _BANG_ = (function (p1__39059_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__39059_SHARP_) : s_BANG_.call(null,p1__39059_SHARP_));
});
...
var G__39079 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__39079) : f_BANG_.call(null,G__39079));
} else {
return null;
}
});
...
var G__39087_39117 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__39087_39117) : s_BANG_.call(null,G__39087_39117));

return missionary.impl.Mailbox.nop;
}
} else {
var G__39089_39118 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__39089_39118) : s_BANG_.call(null,G__39089_39118));
