...
var o28088 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28088["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28089 = temp__5802__auto____$1;
return (o28089["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27619__auto__ = f;
return (o__27619__auto__["toString"]).call(o__27619__auto__);
} else {
return "";
}
}catch (e28102){var _ = e28102;
return "";
}});
...
try{var o__27619__auto___28674 = t;
(o__27619__auto___28674["cljs$lang$ctorPrWriter"]).call(o__27619__auto___28674,t,writer);
}catch (e28130){var __28675 = e28130;
}
...
var char_code = (function (){var o__27619__auto__ = (new String(char$));
return (o__27619__auto__["charCodeAt"]).call(o__27619__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27619__auto__ = String;
return (o__27619__auto__["fromCharCode"]).call(o__27619__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28184 = num_code;
switch (G__28184) {
case (1):
return (185);
...
var o__27619__auto__ = String;
return (o__27619__auto__["fromCharCode"]).call(o__27619__auto__,superscript_code);
});
/**
...
}catch (e28241){var _e__27648__auto__ = e28241;
return false;
}})())){
...
var vec__28251 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28251,(0),null);
...
var G__28693 = (i__5770__auto___28691 + (1));
i__5770__auto___28691 = G__28693;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28338){
var vec__28340 = p__28338;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28340,(0),null);
...
var G__28697 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28698 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28697;
remaining_tokens = G__28698;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28328){
var G__28330 = cljs.core.first(seq28328);
var seq28328__$1 = cljs.core.next(seq28328);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28330,seq28328__$1);
}));
...
var vec__28360 = cljs.core.split_with((function (p1__28358_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28358_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28360,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28360,(1),null);
...
var vec__28383 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28383,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28383,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28707 = cljs.core.rest(remaining_tokens);
var G__28708 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28707;
name_tokens = G__28708;
continue;
} else {
...
var vec__28411 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28411,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28411,(1),null);
var vec__28414 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28414,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28414,(1),null);
var vec__28417 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28417,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28417,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28417,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28417,(3),null);
...
var vec__28442 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28442,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28451 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28451,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28451,(1),null);
var vec__28454 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28454,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28454,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28470 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28470) : devtools.munging.parse_fn_info_deep.call(null,G__28470));
})()));
}
} else {
return fn_info;
...
var G__28725 = (arity + (1));
var G__28726 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28506){
var vec__28509 = p__28506;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28509,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28509,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28535_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28535_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28536_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28536_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___28731 = arguments.length;
var i__5770__auto___28732 = (0);
while(true){
if((i__5770__auto___28732 < len__5769__auto___28731)){
args__5775__auto__.push((arguments[i__5770__auto___28732]));

var G__28733 = (i__5770__auto___28732 + (1));
i__5770__auto___28732 = G__28733;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28543){
var vec__28544 = p__28543;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28544,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28539){
var G__28540 = cljs.core.first(seq28539);
var seq28539__$1 = cljs.core.next(seq28539);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28540,seq28539__$1);
}));
...
var map__28579 = options;
var map__28579__$1 = cljs.core.__destructure_map(map__28579);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28579__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28579__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28579__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28579__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28580 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28580,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28580,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28580,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28580,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28580,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28580,(5),null);
...
var o__27619__auto__ = f;
return (o__27619__auto__["getBasis"]).call(o__27619__auto__);
});
/**
...
}catch (e28590){var _e__27648__auto__ = e28590;
...
var G__28744 = (obj[cljs.core.first(path)]);
var G__28745 = cljs.core.rest(path);
obj = G__28744;
path = G__28745;
continue;
} else {
...
var _STAR_ = (function (accum,p__28604){
var vec__28605 = p__28604;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28605,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28605,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28642){
var vec__28647 = p__28642;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(2),null);
...
var post_process = (function (p__28654){
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28653_SHARP_){
return (obj[cljs.core.first(p1__28653_SHARP_)]);
}),sorted_matches);
