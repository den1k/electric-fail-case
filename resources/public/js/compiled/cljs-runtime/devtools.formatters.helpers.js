...
var G__28719 = devtools.prefs.pref(v);
v = G__28719;
continue;
} else {
return v;
...
}catch (e28679){var _e__27648__auto__ = e28679;
return false;
}})();
...
}catch (e28681){var _e__27648__auto__ = e28681;
return false;
}})();
...
}catch (e28688){var _e__27648__auto__ = e28688;
return false;
}}
}
});
...
var vec__28694 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28694,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28694,(1),null);
...
return cljs.core.some((function (p1__28706_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28706_SHARP_);
}),template);
});
