...
var vec__39806 = cljs.math.setup_hl(ix,hx__$1,lx);
var hx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39806,(0),null);
var lx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39806,(1),null);
var vec__39809 = cljs.math.setup_hl(iy,hy__$1,ly);
var hy__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39809,(0),null);
var ly__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39809,(1),null);
var vec__39812 = (function (){var n = (ix - iy);
var hx__$3 = hx__$2;
var lx__$2 = lx__$1;
while(true){
if((n === (0))){
...
var vec__39836 = (((hz < (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hx__$3 + hx__$3) + (lx__$2 >>> (31))),(lx__$2 + lx__$2)], null):((((hz | lz) === (0)))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Signed zero",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"zero","zero",-858964576),true], null))})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hz + hz) + (lz >>> (31))),(lz + lz)], null)));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39836,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39836,(1),null);
var G__40401 = (n - (1));
var G__40402 = ((4294967295) & hx__$4);
var G__40403 = ((4294967295) & lx__$3);
n = G__40401;
hx__$3 = G__40402;
lx__$2 = G__40403;
continue;
...
var hx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39812,(0),null);
var lx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39812,(1),null);
var hz = ((cljs.math.u_LT_(lx__$2,ly__$1))?((hx__$3 - hy__$2) - (1)):(hx__$3 - hy__$2));
var lz = (lx__$2 - ly__$1);
var vec__39815 = (((hz >= (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hz,lz], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hx__$3,lx__$2], null));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39815,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39815,(1),null);
...
var vec__39818 = (function (){var hx__$5 = hx__$4;
var lx__$4 = lx__$3;
var iy__$1 = iy;
while(true){
if((!((hx__$5 < (1048576))))){
...
var G__40409 = ((hx__$5 + hx__$5) + (lx__$4 >>> (31)));
var G__40410 = (lx__$4 + lx__$4);
var G__40411 = (iy__$1 - (1));
hx__$5 = G__40409;
lx__$4 = G__40410;
iy__$1 = G__40411;
continue;
...
var hx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39818,(0),null);
var lx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39818,(1),null);
var iy__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39818,(2),null);
if((iy__$1 >= (-1022))){
...
var n = ((-1022) - iy__$1);
var vec__39866 = (((n <= (20)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(hx__$5 >> n),((lx__$4 >>> n) | (hx__$5 << ((32) - n)))], null):(((n <= (31)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,((hx__$5 << ((32) - n)) | (lx__$4 >>> n))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,(hx__$5 >> (n - (32)))], null)
));
var hx__$6 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39866,(0),null);
var lx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39866,(1),null);
(i[cljs.math.HI_x] = (hx__$6 | sx));
...
var vec__40303 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40303,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40303,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__40309 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40309,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40309,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__40317 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40317,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40317,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__40332 = (((d > (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40332,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40332,(1),null);
(i[cljs.math.HI] = hr);
...
var G__40500 = (d__$1 * exp_delta);
var G__40501 = (scale_factor__$1 - scale_increment);
d__$1 = G__40500;
scale_factor__$1 = G__40501;
continue;
}
break;
}
